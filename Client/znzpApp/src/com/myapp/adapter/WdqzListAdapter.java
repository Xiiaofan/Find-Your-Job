...
public class WdqzListAdapter extends BaseAdapter {
	...
	public WdqzListAdapter(Context context, List<Map<String, Object>> mData) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.activity_wdqz_list_item,
					null);

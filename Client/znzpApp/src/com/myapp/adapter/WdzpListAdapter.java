...
public class WdzpListAdapter extends BaseAdapter {
	...
	public WdzpListAdapter(Context context, List<Map<String, Object>> mData) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.activity_wdzp_list_item,
					null);

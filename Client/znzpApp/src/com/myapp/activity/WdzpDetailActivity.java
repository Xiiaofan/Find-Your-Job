...
public class WdzpDetailActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_wdzp_detail);
			...
			case 1:
				...
				try {
					...
					URLImageParser imgOBJ = new URLImageParser(tv4,
							WdzpDetailActivity.this);// URLImageGetter

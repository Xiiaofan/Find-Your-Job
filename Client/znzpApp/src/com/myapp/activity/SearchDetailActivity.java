...
public class SearchDetailActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* ProgressDialog */
		pd = ProgressDialog.show(SearchDetailActivity.this, "Title", "Loading, please wait");
			...
			case 1:
				...
				try {
					...
					URLImageParser imgOBJ = new URLImageParser(tv4,
							SearchDetailActivity.this);// URLImageGetter
					...
					if (newsMap.get("typeid").toString().equals("-1")) {
						...
						tv5.setText("Comment(" + newsMap.get("count").toString()
								+ ")");
					}
